...
///------------------------------------------ SCHEMA ------------------------------------------///
var ResearchLibrarySchema = new Schema({
...
var ResearchLibraryModel = mongoose.model('health_facilities_data', ResearchLibrarySchema, 'health_facilities_data');

///------------------------------------------ EXPORT ------------------------------------------///
module.exports = {
    ResearchLibrarySchema: ResearchLibrarySchema,
    ResearchLibraryModel:
        ResearchLibraryModel
};