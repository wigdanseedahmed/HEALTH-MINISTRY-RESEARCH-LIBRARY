...
class AdminSidebarMenuModel
{
  String? title;
  IconData? icon;

  AdminSidebarMenuModel({this.title, this.icon});
}

List<AdminSidebarMenuModel> menuItems =
[
  AdminSidebarMenuModel(title: 'Dashboard', icon: Icons.dashboard),
  AdminSidebarMenuModel(title: 'Notifications', icon: Icons.notification_important),
  AdminSidebarMenuModel(title: 'Web UI', icon: Icons.web),
  AdminSidebarMenuModel(title: 'Charts', icon: Icons.insert_chart),
];