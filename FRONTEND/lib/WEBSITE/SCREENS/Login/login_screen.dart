  ...
  Widget build(BuildContext context) {
    ...
    Container logInButton = Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: kGreenFlagColor.withOpacity(0.1),
            spreadRadius: 10,
            blurRadius: 20,
          ),
        ],
    ...
    Row logInWithSocialMedia = Row(
      ...
      children: [
        loginWithSocialMediaButton(
            context: context, image: 'logo/google.png'),
        loginWithSocialMediaButton(
            context: context, image: 'logo/github.png'),
        loginWithSocialMediaButton(
            context: context, image: 'logo/facebook.png'),
      ],
    );
